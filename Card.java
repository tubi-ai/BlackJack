...
public class Card {
    ...
    public void printCard(Graphics2D g2, boolean dealerTurn, boolean faceDown, int cardNumber) throws IOException {//this method draws the card accordingly (looking to the parameters). It throws a IOException because will be reading some image files.
        ...
        BufferedImage backOfACard = ImageIO.read(new File("images/back.jpg")); //this image will be the back of a card.
